...
from hello_app.controllers.user_controller import CustomSignup, ValidateEmailOTP, Users, UserSearch, UserSearchByMail
...
api.add_resource(UserSearch, '/api/v1/user_search')
# api.add_resource(UserSearchByMail, '/api/v1/maail')